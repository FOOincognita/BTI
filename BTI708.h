/**
*
*  BTI708 Host Linux DRIVER  Version 1.8.1  (01/09/2017)
...
*  gcc 32-bit Driver Library for Ballard Technology ARINC 708
...
BTI708API ERRVAL BTI708_ChClear(INT channum,HCORE handleval);
BTI708API ERRVAL BTI708_ChConfig(UINT32 configval,INT channum,HCORE handleval);
BTI708API VOID BTI708_ChGetCount(LPINT rcvcount,LPINT xmtcount,HCORE handleval);
BTI708API UINT32 BTI708_ChGetInfo(UINT16 infotype,INT channum,HCORE handleval);
BTI708API BOOL BTI708_ChIs708(INT channum,HCORE handleval);
BTI708API BOOL BTI708_ChIsRcv(INT channum,HCORE handleval);
BTI708API BOOL BTI708_ChIsXmt(INT channum,HCORE handleval);
BTI708API VOID BTI708_ChPause(INT channum,HCORE handleval);
BTI708API INT BTI708_ChPauseCheck(INT channum,HCORE handleval);
BTI708API VOID BTI708_ChResume(INT channum,HCORE handleval);
BTI708API BOOL BTI708_ChStart(INT channum,HCORE handleval);
BTI708API BOOL BTI708_ChStop(INT channum,HCORE handleval);
BTI708API ERRVAL BTI708_ChSyncDefine(BOOL enableflag,UINT16 syncmask,UINT16 pinpolarity,INT channum,HCORE handleval);
BTI708API ERRVAL BTI708_ChTriggerDefine(BOOL enableflag,UINT16 trigmask,UINT16 trigval,UINT16 pinpolarity,INT channum,HCORE handleval);
...
BTI708API ERRVAL BTI708_MsgBlockRd(LPMSGFIELDS708 msgfields,MSGNDX msgindex,INT channum,HCORE handleval);
BTI708API ERRVAL BTI708_MsgBlockWr(LPMSGFIELDS708 msgfields,MSGNDX msgindex,INT channum,HCORE handleval);
BTI708API ERRVAL BTI708_MsgDataRd(LPUINT16 buf,MSGNDX msgindex,INT channum,HCORE handleval);
BTI708API ERRVAL BTI708_MsgDataWr(LPUINT16 buf,MSGNDX msgindex,INT channum,HCORE handleval);
BTI708API BOOL BTI708_MsgIsAccessed(MSGNDX msgindex,INT channum,HCORE handleval);
BTI708API ERRVAL BTI708_MsgSyncDefine(BOOL enableflag,UINT16 syncmask,UINT16 pinpolarity,MSGNDX msgindex,INT channum,HCORE handleval);
BTI708API ERRVAL BTI708_MsgTriggerDefine(BOOL enableflag,UINT16 trigmask,UINT16 trigval,UINT16 pinpolarity,MSGNDX msgindex,INT channum,HCORE handleval);
BTI708API ERRVAL BTI708_MsgVarDataRd(LPUINT16 buf,LPINT bitcount,MSGNDX msgindex,INT channum,HCORE handleval);
BTI708API ERRVAL BTI708_MsgVarDataWr(LPUINT16 buf,INT bitcount,MSGNDX msgindex,INT channum,HCORE handleval);
BTI708API ERRVAL BTI708_ParamAmplitudeConfig(UINT32 configval,UINT16 dacval,INT channum,HCORE handleval);
BTI708API ERRVAL BTI708_RcvBuild(UINT32 configval,INT logfreq,INT framecount,INT channum,HCORE handleval);
BTI708API ERRVAL BTI708_XmtBuild(UINT32 configval,UINT16 framefreq,INT logfreq,INT framecount,INT channum,HCORE handleval);
...
BTI708API ERRVAL BTI708_ChConfigEx(UINT32 configval,UINT16 count,INT channum,HCORE handleval);
BTI708API UINT16 BTI708_ChDataCountRd(INT channum,HCORE handleval);
BTI708API UINT16 BTI708_ChDataCountWr(UINT16 countval,INT channum,HCORE handleval);
BTI708API INT BTI708_DllUsageCount(VOID);
BTI708API VOID BTI708_GetChanCount(LPINT rcvcount,LPINT xmtcount,HCORE handleval);
BTI708API ERRVAL BTI708_HookMsgProc(INT msgval,LPVOID lpParam,HCORE handleval);
BTI708API ERRVAL BTI708_HostComm(LPVOID lpParam,HCORE handleval);
BTI708API BOOL BTI708_IsChan(INT channum,HCORE handleval);
BTI708API BOOL BTI708_IsRcvChan(INT channum,HCORE handleval);
BTI708API BOOL BTI708_IsXmtChan(INT channum,HCORE handleval);
BTI708API UINT16 BTI708_MsgActivityRd(MSGNDX msgindex,INT channum,HCORE handleval);
BTI708API VOID BTI708_MsgActivityWr(UINT16 value,MSGNDX msgindex,INT channum,HCORE handleval);
BTI708API MSGADDR BTI708_MsgAddr(MSGNDX msgindex,INT channum,HCORE handleval);
BTI708API ERRVAL BTI708_MsgCommRd(LPMSGFIELDS708 msgfields,MSGNDX msgindex,INT channum,HCORE handleval);
BTI708API ERRVAL BTI708_MsgCommWr(LPMSGFIELDS708 msgfields,MSGNDX msgindex,INT channum,HCORE handleval);
BTI708API ERRVAL BTI708_MsgConfig(UINT32 configval,MSGADDR msgaddr,HCORE handleval);
BTI708API MSGADDR BTI708_MsgCreate(UINT32 configval,HCORE handleval);
BTI708API UINT16 BTI708_MsgOptRd(MSGADDR msgaddr,HCORE handleval);
BTI708API VOID BTI708_MsgOptWr(UINT16 msgopt,MSGADDR msgaddr,HCORE handleval);
BTI708API VOID BTI708_MsgReset(MSGADDR msgaddr,HCORE handleval);
BTI708API BASEADDR BTI708_MsgTableCreate(INT count,HCORE handleval);
BTI708API MSGADDR BTI708_MsgTableRd(MSGNDX msgindex,INT channum,HCORE handleval);
BTI708API VOID BTI708_MsgTableReset(INT channum,HCORE handleval);
BTI708API VOID BTI708_MsgTableWipe(BASEADDR baseaddr,HCORE handleval);
BTI708API ERRVAL BTI708_MsgTableWr(MSGADDR msgaddr,INT channum,HCORE handleval);
BTI708API ERRVAL BTI708_ParamAmplitudeGet(LPUINT16 dacval,INT channum,HCORE handleval);
BTI708API ERRVAL BTI708_ProcSetPost(UINT32 useraddr,INT channum,HCORE handleval);
BTI708API ERRVAL BTI708_ProcSetPre(UINT32 useraddr,INT channum,HCORE handleval);
BTI708API ERRVAL BTI708_TestProtocol(HCORE handleval);
...
enum {	PARAMCFG708_DEFAULT    = 0x00000000L,     //Select all default settings (default)
		...
		PARAMCFG708_AMPLHI     = 0x00000000L,     //Enables parametric amplitude control high range
		PARAMCFG708_AMPLLO     = 0x00000002L,     //Enables parametric amplitude control low range
