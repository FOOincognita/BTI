/**
*
*  BTI Common Socket Functions  (03/01/2015)
*  Copyright (c) 2016
...
/**
*
*  This file provides common functions used to connect to and
*  read from the btiaidsvc data stream.
*
**/
...
int SocketSetupPoll()
{
	if (sigprocmask(SIG_BLOCK, NULL, &G_SOCKETSIGMASK) < 0)
	{
		return 0;
	}
