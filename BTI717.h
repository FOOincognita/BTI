/**
*
*  BTI717 Host Linux DRIVER  Version 1.9.1  (01/09/2017)
...
*  gcc 32-bit Driver Library for Ballard Technology ARINC 717
...
#ifndef LPPARAMFIELDS717
typedef PARAMFIELDS717 * LPPARAMFIELDS717;
#endif
...
BTI717API ERRVAL BTI717_ChClear(INT channum,HCORE handleval);
BTI717API ERRVAL BTI717_ChConfig(UINT32 configval,INT channum,HCORE handleval);
BTI717API VOID BTI717_ChGetCount(LPINT rcvcount,LPINT xmtcount,HCORE handleval);
BTI717API UINT32 BTI717_ChGetInfo(UINT16 infotype,INT channum,HCORE handleval);
BTI717API BOOL BTI717_ChIs717(INT channum,HCORE handleval);
BTI717API BOOL BTI717_ChIsBiPhase(INT channum,HCORE handleval);
BTI717API BOOL BTI717_ChIsRcv(INT channum,HCORE handleval);
BTI717API BOOL BTI717_ChIsSelEnc(INT channum,HCORE handleval);
BTI717API BOOL BTI717_ChIsType(UINT32 configval,INT channum,HCORE handleval);
BTI717API BOOL BTI717_ChIsXmt(INT channum,HCORE handleval);
BTI717API VOID BTI717_ChPause(INT channum,HCORE handleval);
BTI717API INT BTI717_ChPauseCheck(INT channum,HCORE handleval);
BTI717API VOID BTI717_ChResume(INT channum,HCORE handleval);
BTI717API BOOL BTI717_ChStart(INT channum,HCORE handleval);
BTI717API ERRVAL BTI717_ChStatus(LPUINT16 buf,INT channum,HCORE handleval);
BTI717API BOOL BTI717_ChStop(INT channum,HCORE handleval);
BTI717API ERRVAL BTI717_ChSyncDefine(BOOL enableflag,UINT16 syncmask,UINT16 pinpolarity,INT channum,HCORE handleval);
BTI717API ERRVAL BTI717_ChTriggerDefine(BOOL enableflag,UINT16 trigmask,UINT16 trigval,UINT16 pinpolarity,INT channum,HCORE handleval);
BTI717API ERRVAL BTI717_ParamAmplitudeConfig(UINT32 configval,UINT16 dacval,INT channum,HCORE handleval);
BTI717API ERRVAL BTI717_ParamAmplitudeGet(LPUINT16 dacval,INT channum,HCORE handleval);
BTI717API ERRVAL BTI717_SubFrmBlkRd(LPUINT16 databuf,INT subframe,INT channum,HCORE handleval);
BTI717API ERRVAL BTI717_SubFrmBlkWr(LPUINT16 databuf,INT subframe,INT channum,HCORE handleval);
BTI717API ERRVAL BTI717_SubFrmStatus(LPUINT16 buf,INT subframe,INT channum,HCORE handleval);
BTI717API ERRVAL BTI717_SubFrmSyncDefine(BOOL enableflag,UINT16 syncmask,UINT16 pinpolarity,INT subframe,INT channum,HCORE handleval);
BTI717API ERRVAL BTI717_SubFrmTriggerDefine(BOOL enableflag,UINT16 trigmask,UINT16 trigval,UINT16 pinpolarity,INT subframe,INT channum,HCORE handleval);
BTI717API ERRVAL BTI717_SubFrmWordConfig(UINT32 configval,INT subframe,INT word,INT channum,HCORE handleval);
BTI717API ERRVAL BTI717_SubFrmWordRd(LPUINT16 value,INT subframe,INT word,INT channum,HCORE handleval);
BTI717API ERRVAL BTI717_SubFrmWordWr(UINT16 value,INT subframe,INT word,INT channum,HCORE handleval);
BTI717API ERRVAL BTI717_SuperFrmConfig(INT count,INT framespersuperframe,INT channum,HCORE handleval);
BTI717API ERRVAL BTI717_SuperFrmCounterPos(INT subframe,INT word,INT channum,HCORE handleval);
BTI717API ERRVAL BTI717_SuperFrmCounterPosEx(INT subframe,INT word,INT msb,INT lsb,INT channum,HCORE handleval);
BTI717API SUPERFRMADDR BTI717_SuperFrmDefine(INT subframe,INT word,INT channum,HCORE handleval);
BTI717API ERRVAL BTI717_SuperFrmWordConfig(UINT32 configval,INT superfrmnum,SUPERFRMADDR superfrmaddr,INT channum,HCORE handleval);
BTI717API ERRVAL BTI717_SuperFrmWordRd(LPUINT16 value,INT superfrmnum,SUPERFRMADDR superfrmaddr,INT channum,HCORE handleval);
BTI717API ERRVAL BTI717_SuperFrmWordWr(UINT16 value,INT superfrmnum,SUPERFRMADDR superfrmaddr,INT channum,HCORE handleval);
BTI717API BOOL BTI717_SyncTest(INT channum,HCORE handleval);
BTI717API ERRVAL BTI717_SyncValRd(LPINT syncword1,LPINT syncword2,LPINT syncword3,LPINT syncword4,INT channum,HCORE handleval);
BTI717API ERRVAL BTI717_SyncValWr(INT syncword1,INT syncword2,INT syncword3,INT syncword4,INT channum,HCORE handleval);
...
BTI717API BASEADDR BTI717_ChCreate(INT channum,HCORE handleval);
BTI717API ERRVAL BTI717_ChReset(INT channum,HCORE handleval);
BTI717API INT BTI717_DllUsageCount(VOID);
BTI717API VOID BTI717_GetChanCount(LPINT rcvcount,LPINT xmtcount,HCORE handleval);
BTI717API ERRVAL BTI717_HookMsgProc(INT msgval,LPVOID lpParam,HCORE handleval);
BTI717API BOOL BTI717_IsBiPhaseChan(INT channum,HCORE handleval);
BTI717API BOOL BTI717_IsChan(INT channum,HCORE handleval);
BTI717API BOOL BTI717_IsRcvChan(INT channum,HCORE handleval);
BTI717API BOOL BTI717_IsXmtChan(INT channum,HCORE handleval);
BTI717API ERRVAL BTI717_ParamWaveformConfig(UINT32 configval,INT highvolt,INT lowvolt,INT nullvolt,INT channum,HCORE handleval);
BTI717API ERRVAL BTI717_ParamWaveformConfigEx(UINT32 configval,LPPARAMFIELDS717 paramflds,INT channum,HCORE handleval);
BTI717API ERRVAL BTI717_ProcSetPost(UINT32 useraddr,INT channum,HCORE handleval);
BTI717API ERRVAL BTI717_ProcSetPre(UINT32 useraddr,INT channum,HCORE handleval);
BTI717API SUBFRMADDR BTI717_SubFrmAddr(INT subframe,INT channum,HCORE handleval);
BTI717API ERRVAL BTI717_SubFrmBlkRdEx(LPSUBFRMFIELDS717 subfrmdata,INT subframe,INT channum,HCORE handleval);
BTI717API ERRVAL BTI717_SubFrmBlkWrEx(LPSUBFRMFIELDS717 subfrmdata,INT subframe,INT channum,HCORE handleval);
BTI717API ERRVAL BTI717_SubFrmCreate(UINT32 configval,INT subframe,BASEADDR chanbase,HCORE handleval);
BTI717API ERRVAL BTI717_SubFrmReset(INT subframe,INT channum,HCORE handleval);
BTI717API BASEADDR BTI717_SuperFrmBaseAddr(INT channum,HCORE handleval);
BTI717API ERRVAL BTI717_SuperFrmConfigEx(UINT32 configval,INT count,INT framespersuperframe,INT channum,HCORE handleval);
BTI717API ERRVAL BTI717_SuperFrmReset(INT channum,HCORE handleval);
BTI717API ERRVAL BTI717_SyncValPtrInit(INT channum,HCORE handleval);
BTI717API ERRVAL BTI717_TestProtocol(HCORE handleval);
...
enum {	PARAMCFG717_DEFAULT    = 0x00000000L,     //Select all default settings (default)
		...
		PARAMCFG717_WAVEON     = 0x00000000L,     //Enables parametric waveform control (default)
		PARAMCFG717_WAVEOFF    = 0x00000004L,     //Disables parametric waveform control
		PARAMCFG717_CMBIASOFF  = 0x00000000L,     //Disables common-mode DC bias (default)
		PARAMCFG717_CMBIAS     = 0x00000010L      //Enables common-mode DC bias
};
...
enum {	INFO717_PARAM         = 0x0001,           //Channel supports parametric control
		INFO717_PWAVE		  = 0x0002,           //Channel supports parametric waveform (DAC)
		INFO717_CMBIAS        = 0x0003            //Channel supports common-mode DC bias
};
